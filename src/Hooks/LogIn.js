    ...
    <div className='w-full flex justify-center items-center py-10'>
      ...
      <div className='bg-blue-900 max-w-4xl flex justify-center items-center rounded-xl px-5 min-h-64 gap-10'>
        <section className='w-1/2' style={{ marginLeft: '-35px' }}>
          <h2 className='text-4xl font-bold w-full mb-4 bg-gradient-to-r from-white via-yellow-500 to-purple-500 text-transparent bg-clip-text' >Sign in, Be part of the community</h2>
