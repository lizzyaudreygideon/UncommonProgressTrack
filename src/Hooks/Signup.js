...
function Signup({ toggleForm }) {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (err.response) {
        // Error response from the server (status code and message)
        ...
        // Some error during setup or execution of the request
  ...
  return (
    <div className="w-full flex justify-center items-center py-10">
      <div className="bg-blue-900 w-3/4 flex justify-center items-center rounded-xl px-5 min-h-64 gap-10 p-10">
        <section className="w-1/2 -ml-8">
          ...
          <form onSubmit={handleSignup} className="bg-white p-8 rounded-xl w-full max-w-md">
            <div className="mb-4">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50" onClick={() => setShowModal(false)}>
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full mx-4" onClick={e => e.stopPropagation()}>
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Signup Failed</h3>
